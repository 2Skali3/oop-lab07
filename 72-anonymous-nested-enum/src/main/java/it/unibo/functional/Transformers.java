...
public final class Transformers {
     ...
     * For instance, {@code [1, 2, 3, 4, 5]} could use {@code transform} to p roduce a list of squares by passing
     ...
     * collections.
     * For instance, {@code [[1], [2, 3], [5, 5], []]} could use {@code flatten} to produce a flat list, thus obtaining
     * {@code [1, 2, 3, 5, 5]}.
